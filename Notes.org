...
#+begin_src R :results output :session *ssh krakenator* :exports both
...
***** C = 0.2
#+begin_src R :results output graphics :file  (org-babel-temp-file (concat (file-name-directory (or load-file-name buffer-file-name)) "Rfigures/figure-") ".png") :exports both :width 800 :height 800 :session *ssh krakenator* 
Article3_MethodComparison_plot_pvalueGrid(exp, c = 0.2)
#+end_src
...
#+begin_src R :results output :session *R* :exports both
  ...
  methods <- list()
  K <- 40
  hypothesis.testing.func <- phenotypeWayReg_glm_score(calibrate = FALSE,
                                                       family = gaussian,
                                                       factorized.X1 = FALSE)
