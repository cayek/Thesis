...
#+RESULTS:
:        pvalue1 method     id rank
: 1 1.123330e-10  PcaLm 101455    1
: 2 1.489905e-08  PcaLm  36714    3
: 3 1.032922e-06  PcaLm 149131   10
: 4 6.542556e-06  PcaLm 125220   23
...
:END:
#+begin_src R :results output :exports both
  expr <- retrieveExperiment(113)
  expr$description
#+end_src

#+RESULTS:
: [1] "Run on GSE42861 with lfmmLasso|K=10|lambda=1e-10|lfmmLasso|K=30|lambda=1e-10|lfmmLasso|K=60|lambda=1e-10|"
...
#+RESULTS:
:        pvalue1    method     id rank
: 1 1.928065e-15 RidgeLfmm  36714    1
: 2 2.825195e-15 RidgeLfmm 101455    2
: 3 5.270711e-11 RidgeLfmm 125220    4
: 4 3.622480e-10 RidgeLfmm 149131   12
...
disease.state 
     1.185217
       pvalue1    method     id rank
1 1.900259e-11 RidgeLfmm  36714    1
2 2.499142e-11 RidgeLfmm 101455    2
3 2.909836e-08 RidgeLfmm 125220    4
4 1.164002e-07 RidgeLfmm 149131   12
#+end_example
**** sva
***** run
#+begin_src R :results output :exports both
