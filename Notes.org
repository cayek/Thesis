...
**** Plots
:PROPERTIES:
:header-args: :cache no :session *R* :dir ./ :eval no-export :with 1000 :height 800
:END:
...
#+RESULTS:
[[file:/home/cayek/Projects/Thesis/Rfigures/figure-4989oTd.png]]
***** C = 0.6
#+begin_src R :results output graphics :file  (org-babel-temp-file (concat (file-name-directory (or load-file-name buffer-file-name)) "Rfigures/figure-") ".png") :exports both :width 800 :height 800 :session *R* 
...
#+begin_src R :results output :session *tmpR* :exports both :dir TmpNotebook
  library(ThesisRpackage)
  ...
  dat <- sampl(s)
  names(dat)
  saveRDS(dat, "./Data/Simulation_outlier05_cor04.rds")
#+end_src
...
#+begin_src R :results output :session *tmpR* :exports both :dir TmpNotebook
  ...
  ## read data
  dat <- readRDS("./Data/Simulation_outlier05_cor04.rds")
...
Histogram
#+begin_src R :results output graphics :file Rplots/hist_lea.png :exports both :dir ./TmpNotebook :width 600 :height 400 :session *tmpR* 
## plot
...
#+RESULTS:
[[file:/home/cayek/Projects/Thesis/TmpNotebook/Rplots/hist_lea.png]]

Manhattan plot
#+begin_src R :results output graphics :file Rplots/man_lea.png :exports both :dir ./TmpNotebook :width 600 :height 400 :session *tmpR* 
library(ggplot2)
...
#+RESULTS:
[[file:/home/cayek/Projects/Thesis/TmpNotebook/Rplots/man_lea.png]]
...
Histogram
#+begin_src R :results output graphics :file Rplots/lasso_hist.png :exports both :dir TmpNotebook :width 600 :height 400 :session *tmpR* 
  hist(m$pvalue)
#+end_src

#+RESULTS:
[[file:/home/cayek/Projects/Thesis/TmpNotebook/Rplots/lasso_hist.png]]

Manhattan plot
#+begin_src R :results output graphics :file Rplots/lasso_man.png :exports both :dir ./TmpNotebook :width 600 :height 400 :session *tmpR* 
  library(ggplot2)
...
#+RESULTS:
[[file:/home/cayek/Projects/Thesis/TmpNotebook/Rplots/lasso_man.png]]
...
#+begin_src R :results output graphics :file Rplots/lm_hist.png :exports both :dir ./TmpNotebook :width 600 :height 400 :session *tmpR* 
hist(m$pvalue)
#+end_src

#+RESULTS:
[[file:/home/cayek/Projects/Thesis/TmpNotebook/Rplots/lm_hist.png]]

C'est mal calibré.

Manhattan plot
#+begin_src R :results output graphics :file Rplots/lm_man.png :exports both :dir ./TmpNotebook :width 600 :height 400 :session *tmpR* 
  library(ggplot2)
  pvalue <- as.numeric(m$pvalue)
  index <- seq_along(pvalue)
...
#+RESULTS:
[[file:/home/cayek/Projects/Thesis/TmpNotebook/Rplots/lm_man.png]]


#+begin_src R :results output graphics :session *R* :exports both :file Rfigures/test.png :dir ~/Projects/Thesis/
plot(1)
#+end_src

#+RESULTS:
[[file:Rfigures/test.png]]
#+begin_src R :results output graphics :file  (org-babel-temp-file (concat (file-name-directory (or load-file-name buffer-file-name)) "Rfigures/figure-") ".png") :exports both :width 600 :height 400 :session *R* :dir ~/Projects/Thesis/
plot(1)
#+end_src

#+RESULTS:
[[file:/home/cayek/Projects/Thesis/Rfigures/figure-561064W.png]]
...
** STARTED Comparison of methods on generative simu cor(U1/2,X)=c :3Article:
:LOGBOOK:
