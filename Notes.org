...
- Note taken on [2017-04-13 jeu. 17:25] \\
  Je vais essayer de reproduire les resultats que j'avais trouvé pour la pres [[file:3Article/Slides/BCMSeminar/experiments.nb.html][seminarBCM]].
...
*** Run of LFMM ridge with K = 6 and glm
#+begin_src R :results output :exports both
  library(ThesisRpackage)
