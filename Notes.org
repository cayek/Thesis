...
**** RUNNING From big matrix to matrix and scalling
:LOGBOOK:
...
A lil'test
#+begin_src R :results output :exports both
  G <- saveRDS("~/Projects/Thesis/Data/ThesisDataset/3Article/Celiac/G.rds")
  G.clumped <- saveRDS("~/Projects/Thesis/Data/ThesisDataset/3Article/Celiac/G_clumped.rds")
  ind.clumping <- saveRDS("~/Projects/Thesis/Data/ThesisDataset/3Article/Celiac/ind.clumpling.rds")

  mean(abs(G[,ind.clumpling.rds] - G))
#+end_src
