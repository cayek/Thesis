...
#+begin_src R :results output :exports both
  ...
  print(pl)
  save_plot_timc_bcm_15(pl, "1000Genome_scale")

  saveRDS("./Data/ThesisDataset/3Article/1000GenomesPhase3/1000GenomesPhase3_QC_norel_prunned_scaled.rds")
#+end_src
