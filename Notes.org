...
#+begin_src R :results output :exports both
  ...
  s <- TrueSampler(G.file = "~/Projects/Thesis/Data/ThesisDataset/3Article/1000GenomesPhase3/G_EAS.rds",
                   X.file = "~/Projects/Thesis/Data/ThesisDataset/3Article/1000GenomesPhase3/G_EAS.rds",
                   outlier.file = NULL)
...
NULL
NULL
starting worker pid=7521 on localhost:11115 at 16:31:15.698
Loading required package: ThesisRpackage
loaded ThesisRpackage and set parent environment
Loading required package: ThesisRpackage
loaded ThesisRpackage and set parent environment
Loading required package: ThesisRpackage
loaded ThesisRpackage and set parent environment
...
Loading required package: ThesisRpackage
loaded ThesisRpackage and set parent environment
TRACE [2017-05-29 16:32:47] attaching impute
...
** DONE Validation numérique pour l'article "LFMM"                :3Article:
