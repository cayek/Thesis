...
** Étude de [[#Liu_2013][GSE42861]]                                              :3Article:
*** Data pre-processing
#+begin_src R :results output :exports both
  library(ThesisRpackage)
  ...
  saveRDS(X, "~/Projects/Thesis/s/Data/ThesisDataset/3Article/GSE42861/X.rds")
#+end_src
...
#+begin_src R :results output :exports both
  ...
  X <- readRDS("~/Projects/Thesis/s/Data/ThesisDataset/3Article/GSE42861/X.rds")
  X <- X[,1]
  head(X)

  s <- TrueSampler(G.file = "")
  expr <- expr
