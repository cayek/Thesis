...
#+begin_src R :results output :exports both
  ...
  dat.Eu$indiv <- dat$indiv[Eu.ind,]
  dat.Eu$G <- dat$G[Eu.ind,sample.loci]
  ...
  ## PCA
  svd.res <- svd(dat.Eu$G, nu = 0, nv = 0)
  ...
  ## save
  saveRDS(dat.Eu, "~/Projects/Thesis/Data/ThesisDataset/3Article/1000GenomesPhase3/Eu.maf.05.rds")
#+end_src
...
#+begin_src R :results output :exports both
  require(ThesisRpackage)
  G.file <- "~/Projects/Thesis/Data/ThesisDataset/3Article/1000GenomesPhase3/Eu.maf.05.rds"
