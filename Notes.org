...
#+begin_src R :results output :exports both
  ...
  system("rm -f plink_merge.out")
  system(cmd)
#+end_src
****** TODO Remove correlated indiv
:LOGBOOK:
- State "TODO"       from              [2017-05-17 mer. 17:05]
:END:
#+begin_src R :results output :exports both
  ...
  print(bedfileQC2)
#+end_src
****** TODO Convert the dataset into bigmatrix
:LOGBOOK:
...
#+begin_src R :results output :exports both
  ...
  setwd("~/Projects/Thesis/Data/1000Genomes/Phase3/plink")
  plink <- "/home/cayek/BiocompSoftware/plink/plink"
  bedfileQC2 <- "1000GenomePhase3_QC_norel.bed"

  snp_readBed(bedfileQC2, "1000GenomePhase3")
#+end_src
****** TODO LD prunning/clumping
:LOGBOOK:
- State "TODO"       from              [2017-05-17 mer. 17:06]
:END:
#+begin_src R :results output :exports both
  library(bigsnpr)
  genome1000 <- snp_attach("~/Projects/Thesis/Data/1000Genomes/Phase3/plink/backingfiles/1000GenomePhase3.rds")
  ind.keep <- snp_clumping(G = genome1000$genotypes,
                            infos.chr = genome1000$map$chromosome,
                            thr.r2 = 0.2)
  saveRDS(ind.keep, "~/Projects/Thesis/Data/1000Genomes/Phase3/plink/1000GenomesPhase3_clumping_ind.rds")

#+end_src
****** TODO Convert into R matrix
:LOGBOOK:
...
On pars d'un dataset deja imputé pour trouver une liste d'indice a garder ! 
#+begin_src R :results output :exports both
  library(bigsnpr)
