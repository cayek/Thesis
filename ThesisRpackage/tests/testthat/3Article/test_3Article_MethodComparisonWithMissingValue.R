library(testthat)
context("Article3_MethodComparisonWithMissingValue")

test_that("Article3_MethodComparisonWithMissingValue", {
  G.file <- "~/Projects/Thesis/Data/1000Genomes/Phase3Chrm22/European_Chrm22.maf.05.rds"
  skip_if_not(file.exists(G.file))

  exp <- Article3_MethodComparisonWithMissingValue(G.file = G.file,
