...
homozygote locus~/citep{Frichot2014}. For a diploid organism each genotypic
...
\paragraph{Range parameter} Testing correlations between genetic and geographic data
...
obtained with the {\tt snmf} method that reproduces the outputs of the {\tt
  structure} program accurately~\citep{Frichot2014}~\citep{Frichot2015}. To quantify the
...
\paragraph{Application to human data} To evaluate the robustness of our approach
